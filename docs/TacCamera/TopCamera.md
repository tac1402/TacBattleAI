...
1. WASD - направляет камеру в соответствующую сторону (обрабатывает [FastController](../../FastController.md))
2. Right Button Mouse - при нажатии поворачивает камеру (обрабатывает TopCamera)
3. Scroll Mouse - приближает/отдаляяет камеру (обрабатывает [FastController](../../FastController.md))
