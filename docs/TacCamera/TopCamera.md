...
- WASD - направляет камеру в соответствующую сторону (принимает [FastController](../../FastController.md))
- Right Button Mouse - при нажатии поворачивает камеру (принимает TopCamera)
- Scroll Mouse - приближает/отдаляяет камеру принимает ([FastController](../../FastController.md))
