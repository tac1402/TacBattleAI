...
Класс [SaveManager](../../TacSave/SaveManage) вам нужно реализовать самостоятельно, наследуясь от [SaveManager0](../../TacSave/SaveManage0). Эта реализация позволит вам полностью контролировать сохранение данных и удаление/востановление объектов в сцене.
