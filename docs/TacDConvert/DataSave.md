...
Такой формат позволяет получить текущие значение __СвойстваДляСохранения__, через Linq получить сигнатуру __СвойстваДляСохранения__ и обратно присвоить значение в __СвойствоДляСохранения__. Таким образом, он служит сразу для 3 сценариев: сохранения, загрузки и получения мета данных.
