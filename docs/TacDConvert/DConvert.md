...
Самое важное на этом этапе понять, что происходит в момент загрузки? Не продолжение, а реконструкция. Отсюда у нас стоит задача выделить минимально возможное количество данных, которые нужно сохранить, что при закрузке было бы возможным реконструировать систему заново с прерванного момента.
