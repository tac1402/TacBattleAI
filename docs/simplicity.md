...
__Наш текущий подход__ с организацией папок и asmref — это практичное решение, навязанное существующими ограничениями языка C# и экосистемы Unity. (_подробнее см._ [линковка](linking.md))
