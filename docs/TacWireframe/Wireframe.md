...
Компонент расширяет [Item2](../../TacStandart/Item2).
...
Используются материалы для отображения сетки разных цветов красной/зеленной/серой.

## CurrentMode

Текущий режим отображения сетки.
