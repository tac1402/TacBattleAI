...
Особенностью библиотек Tac является их продумманная архитектура и легкость, благодаря чему их можно собирать как конструктор для разных прототипов игр. На данный момент можно выделить: 
